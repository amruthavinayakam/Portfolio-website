        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="mt-5 flex gap-4 border-t border-line pt-4 text-sm font-medium">
              {/* ::after stretches the primary link over the whole card, so
                  clicking anywhere opens it — one real anchor rather than
                  nesting links inside a card-wide <a>. The repo link is
                  primary when present; otherwise the demo link takes over. */}
              {project.github && (
                <a
                  href={project.github}
                  target="_blank"
